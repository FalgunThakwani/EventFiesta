...
public class ForgotPassword {
    ...
    public Boolean validateOTP(Account organizer) {
        try {
            Integer otp = organizer.getOtp();
            IDBPersistence mySQLDBPersistence = new MySQLDBPersistence();
            Object[] params = new Object[]{"OrganizerSensitive", "otp, otp_time", "organizer_id", organizer.getAccountId().toString()};ArrayList<HashMap<String, Object>> data = mySQLDBPersistence.loadData("getFromDBUsingWhere", params);
