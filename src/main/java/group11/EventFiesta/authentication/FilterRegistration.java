...
public class FilterRegistration {
    ...
    public FilterRegistrationBean registerAuthenticationFilter() {
        ...
        registration.addInitParameter("EXCLUDE_URL_PATTERN",
                "/.*.jpg|/.*.css|/home|/organizer/login|/handleOrganizerLogin|/signup|/handleUserSignUp|/|/userLogin|/handleUserLogin|/forgotPassword|/resetPassword|/securityQuestion|/aboutUs|/ourServices|/blog|/contactUs|/userEventChecklist");
